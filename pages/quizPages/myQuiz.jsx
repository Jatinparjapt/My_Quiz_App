...
const selectQuestionDelete =  async (isId)=>{
  ...
  console.log(isId)
    if(deleteConfirm){
      const data = await axios.delete("https://elastic-voice-production.up.railway.app/api/deleteQuestion",{ data: { id: isId }})
 ...
 const changeHideSetting = async (e)=>{
  setRadioButtonValue(true)
   ...
   const updateQuestionInDatabase =  await axios.put(`https://elastic-voice-production.up.railway.app/api/updateQuestion`,  {
